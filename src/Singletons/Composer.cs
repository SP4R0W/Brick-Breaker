...
public class Composer : Node
{
    ...
    private Dictionary<string,int> screen = new Dictionary<string, int>()
    {
    ...
    private async void DefferedGotoScene(string newScene,bool animate=true,string animation="fade")
    {
