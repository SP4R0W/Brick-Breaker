...
public class Ball : KinematicBody2D
{
    ...
    private bool isBallStarted = false;
    private bool isGrace = false;
    private bool isBallImmune = false;
    private bool isBallDestructive = false;
    ...
    private void EndCollisionTimer(CollisionShape2D shape)
    {
