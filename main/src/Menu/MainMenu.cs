...
public class MainMenu : Node
{
    ...
    public async override void _Ready()
    {
        ...
        if (!isBrowserGame)
            tween.InterpolateProperty(button5,"modulate:a",0,1,1,Tween.TransitionType.Linear,Tween.EaseType.InOut,2.5f); // Hide the exit game button if playing on a browser
