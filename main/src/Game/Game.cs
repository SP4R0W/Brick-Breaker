...
public class Game : Node
{
    ...
    PackedScene brickScene = (PackedScene)ResourceLoader.Load("res://src/Game/Objects/Brick.tscn");
    PackedScene powerupScene = (PackedScene)ResourceLoader.Load("res://src/Game/Objects/Powerup.tscn");

    Dictionary<Brick,Godot.Collections.Array> brickDict = new Dictionary<Brick,Godot.Collections.Array>();

    Dictionary<string,int> brickScore = new Dictionary<string, int>()
    {
    ...
    void CheckPowerup(string powerup)
    {
    ...
    void SpawnPowerup(Vector2 brickPos)
    {
        ...
        else if (powerupChance > rand)
        {
            ...
            if (powerupNum != "4294967295") // Fix for a weird bug that sometimes gave this number for a powerup lol
    ...
    void UpdateTrackName(int newTrack)
    {
    ...
    void UpdateLoopText(bool newLoop)
    {
    ...
    Godot.Collections.Dictionary<string, Godot.Collections.Array> GetFile()
    {
