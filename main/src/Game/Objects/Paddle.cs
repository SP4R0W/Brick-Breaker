...
public class Paddle : KinematicBody2D
{
    ...
    float speedMultiplier = 1f; // This is used for powerups changing paddle's speed
    ...
    PackedScene bullet = (PackedScene)ResourceLoader.Load("res://src/Game/Objects/Bullet.tscn");
