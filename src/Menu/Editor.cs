...
public class Editor : Node
{
    ...
    private Dictionary<string,Godot.Collections.Array> mainLevelDict = new Dictionary<string, Godot.Collections.Array>(){};
    ...
    private PackedScene brickScene = (PackedScene)ResourceLoader.Load("res://src/Menu/Editor/EditorBrick.tscn");
    ...
    private AudioStreamPlayer ask;
    private AudioStreamPlayer change;
    ...
    private void BrickClicked(EditorBrick brick,int mouseStatus)
    {
    ...
    private void EditTitle(string newText)
    {
    ...
    private void EditAuthor(string newText)
    {
    ...
    private void ConfirmFileSelect(string path)
    {
